...
import { MdDeleteOutline, MdKeyboardArrowLeft, MdKeyboardArrowRight, MdOutlineDriveFileMove, MdOutlineMarkEmailUnread, MdOutlineReport, MdOutlineTask, MdOutlineWatchLater } from 'react-icons/md';
...
const Mail = () => {
    ...
    const deleteHandler = async () =>{
        try {
            const res = await axios.delete(`http://localhost:5000/api/v1/email/${params.id}`,{
